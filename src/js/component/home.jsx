...
const Home = () => {
    ...
    if(color3 === "btn-success"){
		...
		setShadow3("0px 0px 100px green ");
		setColor1("");
		setColor2("");
		setShadow1("");
		setShadow2("");
...
console.log(shadow1)
	return (
		<div className="col-12 bg-dark">
            ...
            <button className={"btn rounded-circle border-danger p-3 mb-2 m-auto "+color1} style={{width: 50, height: 50, boxShadow:shadow1}} onClick={encenderRojo}></button>
            ...
            <button className={"btn rounded-circle border-success p-1 mb-2 m-auto "+color3} style={{width: 50, height: 50,boxShadow:shadow3}} onClick={encenderVerde}></button>
		</div>
		</div>
	);
